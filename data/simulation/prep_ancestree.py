...
'''
Prep the output of simulation for input to ancestree
'''
...
def make_matrix(total, variant):
  ...
  '''
  df_total = pd.read_csv(total, header=0, index_col=0).T
  df_var = pd.read_csv(variant, header=0,index_col=0).T
  # print(df_total)
  # print(df_var)
